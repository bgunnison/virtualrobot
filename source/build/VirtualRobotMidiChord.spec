...
a = Analysis([  '..\\ui\\mainchord.py',
                '..\\midiapps\\midi_chord.py',
                '..\\midiapps\\midi_effect_manager.py',
                '..\\common\\midi.py',
                '..\\common\\upper_class_utils.py'
                ],
             pathex=['C:\\projects\\virtualrobotcompany\\bgunnison\\virtualrobot\\source\\buildchord'],
             binaries=[ ('../ui/mainchord.kv', '.'), 
